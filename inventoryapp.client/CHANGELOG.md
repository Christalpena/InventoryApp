...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest inventoryapp.client -- --template=react-ts`.
- Crear archivo de proyecto (`inventoryapp.client.esproj`).
